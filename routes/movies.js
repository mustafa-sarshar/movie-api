const { Director: Directors, Actor: Actors, Genre: Genres, Movie: Movies } = require("../models/models");
...
module.exports = { getMovies, getMovieByTitle, getGenreByName, getDirectorByName, getActorByName };