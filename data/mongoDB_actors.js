...
actors.push({
  ...
  birth: new Date("1937-12-31"),
  death: "",
});

actors.push({
  name: "Lawrence A. Bonney",
  bio: "Bonney is an American actor best remembered for his only film role in the Academy Award winning film The Silence of the Lambs (1991) directed by Jonathan Demme, where Bonney plays an FBI instructor who assists Clarice Starling (played by Jodie Foster) during a training routine in the early minutes of the classic film.",
  birth: "",
  death: "",
});
...
actors.push({
  ...
  bio: "With an almost unpronounceable surname and a thick Austrian accent, who would have ever believed that a brash, quick talking bodybuilder from a small European village would become one of Hollywood's biggest stars, marry into the prestigious Kennedy family, amass a fortune via shrewd investments and one day be the Governor of California!?",
...
actors.push({
  ...
  birth: new Date("1924-04-03"),
  death: new Date("2004-07-01"),
});
...
actors.push({
  ...
  birth: new Date("1940-03-26"),
  death: new Date("2022-07-06"),
});
